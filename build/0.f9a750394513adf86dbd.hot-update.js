	...
	var ChatContainer = (function (_React$Component) {
	  ...
	  _createClass(ChatContainer, [{
	    ...
	    value: function componentDidMount() {
	      _storesChatStore2['default'].fetchSurvey();
	    }
	  }, {
	    key: 'submitSurvey',
	    value: function submitSurvey(chatLogID) {
	      _storesChatStore2['default'].submitSurvey(chatLogID);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        {
	          stores: { ChatStore: _storesChatStore2['default'] },
	...
	var Chatbox = (function (_React$Component) {
	  ...
	  _createClass(Chatbox, [{
	    ...
	    value: function convertMessage(message) {
	      // TODO: Refactor this converter
	      switch (message) {
	        case 'happy':
	          return _react2['default'].createElement('img', { src: '/assets/face-happy.svg' });
	        case 'meh':
	          return _react2['default'].createElement('img', { src: '/assets/face-meh.svg' });
	        case 'sad':
	          return _react2['default'].createElement('img', { src: '/assets/face-sad.svg' });
	        default:
	          return message;
	      }
	    }
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            chatLog.map(function (chatLog) {
	              if (chatLog.user === 'user') {
	                return _react2['default'].createElement(
	                  'div',
	                  { key: chatLog.id, className: 'MessageContainer' },
	                  _react2['default'].createElement(
	                    'div',
	                    { className: 'LeftChatMessage' },
	                    _this.convertMessage(chatLog.message)
	                  ),
	                  _react2['default'].createElement(_Avatar2['default'], { position: 'RightAvatar', user: chatLog.user, url: _this.props.ChatStore.images.user })
	                );
	              } else if (chatLog.user === 'bot') {
	                return _react2['default'].createElement(
	                  'div',
	                  { key: chatLog.id, className: 'MessageContainer' },
	                  _react2['default'].createElement(_Avatar2['default'], { position: 'LeftAvatar', user: chatLog.user, url: _this.props.ChatStore.images.bot }),
	                  _react2['default'].createElement(
	                    'div',
	                    { className: 'RightChatMessage' },
	                    chatLog.message
	                  )
	                );
	              }
	            ...
	            botThinking ? _react2['default'].createElement(
	              'div',
	              { className: 'MessageContainer thinking' },
	              _react2['default'].createElement(
	                'div',
	                { className: 'RightChatMessage' },
	                '...'
	  ...
	  _createClass(Avatar, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('img', { href: this.props.url, alt: this.props.user })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserResponseHoursSlept = __webpack_require__(234);
	
	var _UserResponseHoursSlept2 = _interopRequireDefault(_UserResponseHoursSlept);
	...
	var ResponsePane = (function (_React$Component) {
	  ...
	  _createClass(ResponsePane, [{
	    key: 'render',
	    value: function render() {
	      var currentChatLogPosition = this.props.ChatStore.currentChatLogPosition;
	      var currentSurveyCall = this.props.ChatStore.survey[currentChatLogPosition];
	      return _react2['default'].createElement(
	        'div',
	    ...
	    value: function handleResponseType(currentSurveyCall) {
	      ...
	      switch (currentSurveyCall.response.type) {
	        case _constantsEnums.ResponseType.None:
	          return null;
	        case _constantsEnums.ResponseType.HoursSlept:
	          return _react2['default'].createElement(_UserResponseHoursSlept2['default'], this.props);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserResponseFaceMood = (function (_React$Component) {
	  ...
	  _createClass(UserResponseFaceMood, [{
	    key: 'handleClick',
	    value: function handleClick(faceType) {
	      this.props.ChatActions.pushUserResponse(faceType);
	      this.props.submitSurvey(this.props.ChatStore.currentChatLogPosition);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'button',
	          { className: 'UserResponseFaceMoodChildren', onClick: this.handleClick.bind(this, 'happy') },
	          'Happy'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: 'UserResponseFaceMoodChildren', onClick: this.handleClick.bind(this, 'meh') },
	          'Meh'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { className: 'UserResponseFaceMoodChildren', onClick: this.handleClick.bind(this, 'sad') },
	          'Sad'
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatStore = (function () {
	  function ChatStore() {
	    ...
	    this.currentChatLogPosition = 0;
	    this.chatLogID = 0;
	    this.surveyIsReady = false;
	    this.survey = [];
	    this.errorMessage = null;
	    this.responseType = _constantsEnums.ResponseType.None;
	    this.images = {
	      user: 'placeholder',
	      bot: 'placeholder'
	    };
	    ...
	    this.bindListeners({
	      ...
	      handlePushBotResponse: _actionsChatActions2['default'].PUSH_BOT_RESPONSE,
	  ...
	  _createClass(ChatStore, [{
	    ...
	    value: function handlePushUserResponse(message) {
	      var chatBotDelay = (Math.random() + 0.5) * 1000;
	      this.survey[this.currentChatLogPosition].response.content = message;
	      this.currentChatLogPosition += 1;
	      this.chatLog.push({ id: this.chatLogID, message: message, user: 'user' });
	      this.chatLogID += 1;
	      this.botThinking = true;
	      setTimeout(function () {
	        _actionsChatActions2['default'].pushBotResponse();
	      }, chatBotDelay);
	    }
	  }, {
	    key: 'handlePushBotResponse',
	    value: function handlePushBotResponse() {
	      this.botThinking = false;
	      this.chatLog.push({ id: this.chatLogID, message: this.survey[this.currentChatLogPosition].call.content, user: 'bot' });
	      this.chatLogID += 1;
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatActions = (function () {
	  ...
	  _createClass(ChatActions, [{
	    ...
	    key: 'pushBotResponse',
	    value: function pushBotResponse() {
	      this.dispatch();
	    }
	  }, {
	    key: 'botContinueChat',
	    value: function botContinueChat() {
	      this.dispatch();
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantsSurveyJsx2 = _interopRequireDefault(_constantsSurveyJsx);
	
	var resolveFetchSurveyPromiseTimeout = function resolveFetchSurveyPromiseTimeout(resolve, reject) {
	
	  if (true) {
	    resolve(_constantsSurveyJsx2['default']);
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatActions = __webpack_require__(222);
	...
	var SurveyActions = (function () {
	  ...
	  _createClass(SurveyActions, [{
	    ...
	    value: function fetchSurveySuccess(survey) {
	      ...
	      _ChatActions2['default'].pushBotResponse(survey[0].call.content);
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = [{
	  ...
	  call: {
	    type: 'statement',
	    content: 'Thanks for letting me know! Did you get much sleep last night?\nAround how many hours?'
	  },
	  response: {
	    type: _Enums.ResponseType.HoursSlept
	  }
	}, {
	  id: 2,
	  call: {
	  ...
	  _createClass(DateFormatter, [{
	    ...
	    value: function getTime() {
	      ...
	      if (this.datetime.getHours() > 11) {
	        time = this.datetime.getHours() - 12 + ':' + this.datetime.getMinutes() + ' pm';
	      } else {
	        time = this.datetime.getHours() + ':' + this.datetime.getMinutes() + ' am';
	      }
	      return time;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HourSelection = (function (_React$Component) {
	  _inherits(HourSelection, _React$Component);
	
	  function HourSelection(props) {
	    _classCallCheck(this, HourSelection);
	
	    _get(Object.getPrototypeOf(HourSelection.prototype), 'constructor', this).call(this, props);
	    this.handleClick = this.handleClick.bind(this);
	  }
	
	  _createClass(HourSelection, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'UserResponseHoursSlept' },
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.handleClick.bind(this, 'More than 8') },
	          'More than 8 hours'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.handleClick.bind(this, '6-8 hours') },
	          '6-8 hours'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.handleClick.bind(this, '4-6 hours') },
	          '4-6 hours'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.handleClick.bind(this, '2-6 hours') },
	          '2-6 hours'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.handleClick.bind(this, '0-2 hours') },
	          'Less than 2 hours'
	        )
	      );
	    }
	...
	exports['default'] = HourSelection;
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(194); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "UserResponseHoursSlept.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))

/***/ }

})
//# sourceMappingURL=0.f9a750394513adf86dbd.hot-update.js.map